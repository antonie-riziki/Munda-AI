"""
Django settings for munda_ai project.
...
SECRET_KEY = 'django-insecure-jbwx)4&9yael@mi-qkoaed)j1q8k5)80f6tmwkkcwa*)0$x^=9'
...
ROOT_URLCONF = 'munda_ai.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [r'MUNDA-AI/munda_ai/munda_app/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'munda_ai.wsgi.application'
